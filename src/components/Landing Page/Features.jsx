...
const Features = () => {
  return (
    <section className='container mx-auto py-8 px-4 sm:py-16 xl:px-16'>
      ...
      <div className='space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3'>
        <div>
          <div className='mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primaryLight lg:h-12 lg:w-12'>
            <svg
              className='h-5 w-5 text-primaryDark lg:h-6 lg:w-6'
              fill='currentColor'
              viewBox='0 0 20 20'
